...
public class PathFar9Ball extends PathManager {
    ...
    public void addRedPaths() {
                ...
                pathBuilder()
                        .addPath(
                                new BezierCurve(
                                        ...
                                        , new Pose(82.600, 33.600)
                                        , new Pose(95.700, 34.900)
                                )
                        )
        ...
        // name: Intake GPP, color: #979D79
                pathBuilder()
                        .addPath(
                                new BezierLine(new Pose(95.700, 34.900), new Pose(133.000, 36.000))
                        )
        ...
        addRedPath(
        // name: Shoot3 far, color: #BA5BB8
                pathBuilder()
                        .addPath(
                                new BezierCurve(
                                        new Pose(133.000, 60.000)
                                        , new Pose(91.200, 53.100)
                                        , new Pose(91.200, 72.000)
                                )
                        )
    ...
    public void addBluePaths() {
                ...
                pathBuilder()
                        .addPath(
                                new BezierCurve(
                                        ...
                                        , new Pose(61.400, 33.600)
                                        , new Pose(48.300, 34.900)
                                )
                        )
        ...
        // name: Intake GPP, color: #979D79
                pathBuilder()
                        .addPath(
                                new BezierLine(new Pose(48.300, 34.900), new Pose(11.000, 36.000))
                        )
                ...
                pathBuilder()
                        .addPath(
                                new BezierCurve(
                                        ...
                                        , new Pose(52.800, 53.100)
                                        , new Pose(52.800, 72.000)
                                )
                        )
                        .setTangentHeadingInterpolation()
                        .applyFollowupShotSequence(ZoneDistance.FAR)
