...
public class PathFar6BallPark extends PathManager {

    public PathFar6BallPark(RobotSystem robot) {
        super(robot);
        addPaths();
    }
    ...
    public void addBluePaths() {
        ...
        addBluePath(
        // name: Park, color: #7BAAAC
                pathBuilder()
                        .setGlobalDeceleration()
                        .addPath(
                                new BezierLine(new Pose(54.000, 17.000), new Pose(16.000, 36.000))
                        )
    ...
    public void addRedPaths() {
        ...
        // name: Park, color: #7BAAAC
                pathBuilder()
                        .setGlobalDeceleration()
                        .addPath(
                                new BezierLine(new Pose(90.000, 17.000), new Pose(128.000, 36.000))
                        )
