...
public class PathNear6BallPark extends PathManager {

    public PathNear6BallPark(RobotSystem robot) {
        super(robot);
        addPaths();
    }
    ...
    public void addRedPaths() {
        ...
        addRedPath(
        // name: Park, color: #8DC859
                pathBuilder()
                        .addPath(
                                new BezierCurve(
                                        new Pose(89.000, 109.500)
                                        , new Pose(83.100, 83.600)
                                        , new Pose(119.800, 84.000)
                                )
                        )
                ...
                pathBuilder()
                        .addPath(
                                new BezierCurve(
                                        ...
                                        , new Pose(60.900, 83.600)
                                        , new Pose(24.200, 84.000)
                                )
                        )
                        .setTangentHeadingInterpolation()
                        .build()
